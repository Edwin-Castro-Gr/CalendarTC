...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form method="POST" action="<?= route_to('send_password_reset_link') ?>">
       <?= csrf_field() ?> 
       <?php if (!empty(session()->getFlashdata('success'))): ?> 
        ...
        <div class="input-group custom">
            <input type="text" class="form-control form-control-lg" placeholder="Email" name="email" id="email" value="<?= set_value('email') ?>">
